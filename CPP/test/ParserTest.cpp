...
BOOST_AUTO_TEST_CASE ( tokenizerTest ) {
	...
	{ // MAC
		...
		BOOST_CHECK_EQUAL(mac.toString(), "4C:11:AE:EF:E8:BE");
...
BOOST_AUTO_TEST_CASE ( parsersOnTestFiles ) {
	{
		PARSER_ON_TESTFILE_HEADER("testFiles/radioData.csv", 11);
	...
	{
		PARSER_ON_TESTFILE_HEADER("testFiles/sensorData.csv", 16698);
		...
		PARSER_ON_TESTFILE_TEST_NEXT_EVENT(StepDetectorEvent,		44737425, 21, "1.0");
